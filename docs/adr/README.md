...
| [ADR-0051](0051-seaweedfs-mount-produced-by-a-privileged-daemonset.md) | The SeaweedFS object mount is produced by a privileged per-node DaemonSet | Proposed |
