...
- **PR-29's artifacts — the deferral now has a trigger and a shape.** ADR-0083 (Accepted) keeps
  ...
  the reopen is one decision smaller. Check 15 holds the absence until then.
