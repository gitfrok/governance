...
| T-0087 | The BFF's plane partition | ADR-0094 carry | **Done (2026-09-22)** — bff@ec3d6c9; 8/10. Both refusals, 11 control + 26 data-plane registrations, manifests gated. **AC7 blocked** (no enrolment-record field), **AC8 not done** (arch-gate walk; ADR-0100 d6 made the property structural instead) |
