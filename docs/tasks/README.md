...
| T-0050 | Code search in the web UI, with an honest empty state | 4 | Todo — SPEC-0049; EP-25; the empty page is the same shape for "nothing matched", "you may not see it" and "nothing is indexed" |
