...
| T-0089 | The custody client can be given a CA, and refuses to guess | ADR-0104 carry | Todo — SPEC-0071 AC1–AC7; `backend`. Explicit `Config.CAFile` + `GITFROK_CUSTODY_CA_FILE`, appended to the system pool never substituted for it, and every wrong file a construction error naming the path rather than a silent fallback |
