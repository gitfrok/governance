...
| T-0087 | The BFF's plane partition | ADR-0094 carry | In progress — SPEC-0070 Approved after ADR-0100 shrank the blocker to four door registrations (T-0088). AC1–AC6 + AC9 implementable; **AC7 blocked** on ADR-0094's enrolment-record row, and AC6's deployment cannot verify a session until that register row is answered. Four repos |
