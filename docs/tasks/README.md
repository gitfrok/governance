...
| T-0088 | Register the control plane's four service doors | ADR-0094/0100 carry | Todo — RED may begin. Four `Register…Server` calls on an existing listener; every module is already wired and in-process there. backend only, no spec (ADR-0100 decision 1 is the specification) |
