...
The task's spec in `docs/specs/`, its acceptance criteria, and
`docs/process/definition-of-done.md`. Criteria the spec did not state are not yours to
...
and `.` has a record of intermittent failures being sampled once and called green. Soften a
