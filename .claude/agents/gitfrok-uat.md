...
Read `docs/product/PRD.md` for what the product promises this persona, and
`docs/adr/0015-uiux-github-clean-unified-security.md` for how the surface is meant to feel.
